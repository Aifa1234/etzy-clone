                                        ...
                                        <a href="#" class="card1-item-link">
                                            ...
                                            <div class="card1-content">
                                                        ...
                                                        <span class="dot1">·</span>
                                                         <div class="letter-container">
                                                            <div class="letter-wrapper">
                                                                <span class="letter-icon" ${(index===6||index===9||index===10)?`style="display:none"`:""}>
                                                ...
                                                <div class="price1-container">
                                                    ...
                                                    ${index===8? `<span class="eligible-container"><button class="eligible-button">Eligible orders get 20% off<button></span>`:""}
                                                </div>
                                                <div class="blank"></div>
                                            </div>
                                        </a>
